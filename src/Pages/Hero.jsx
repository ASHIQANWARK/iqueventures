...
const HeroSection = () => {
  ...
  return (
    <section className="relative font-['Open Sans'] overflow-hidden pt-5">
      {/* Two-tone Background */}
      ...
      <div className="relative z-10 py-20">
        <div className="max-w-7xl mx-auto px-4 flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
          ...
          >
            <h1 className="text-white font-bold text-3xl sm:text-4xl md:text-5xl leading-tight mb-6 text-left">
              Let's create,
              <br />
            ...
            <p className="text-base sm:text-lg text-white mb-5 text-left">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 mt-20">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-white tracking-wide">
            What we focus on :
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {focusItems.map((item, idx) => (
              <motion.div
                ...
                className="relative bg-[#005c6d] text-white rounded-lg shadow-lg px-6 py-8 text-center border border-white/20 hover:shadow-[0_0_25px_#2effb5aa] transition w-full h-[380px] mx-auto"
              >
                <img
                  src={svg2}
                  alt="bg"
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full">
                  ...
                  <h4 className="text-lg font-bold leading-snug text-center px-2">
                    {item.title}
                  </h4>
